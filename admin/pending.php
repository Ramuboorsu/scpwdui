    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <center><h5 class="card-title"><b>Received Grievance</b></h5></center>
                ...
                <th>Action</th>
                                ...
                                <?php
        $cnt =1;
$sel = mysqli_query($con,"select * from complaints_form where status='Pending'");
...
?>
            <tr>
                ...
                <td><a href="pending.php?a=diposedoff&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">Disposed Off</a>
 <a href="pending.php?u=underprocess&id=<?php echo $id; ?>" class="btn btn-danger" onclick="return updateconfirm()">Under Process</a>
<a href="pending.php?t=tobeattended&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">To Be Attended</a>
<a href="complaintupdate.php?id=<?php echo $id;?>" class="btn btn-success">Update</a>
</td>
