    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><b>Go's List</b></h5>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                <tbody>
                                <?php
$sel = mysqli_query($con,"select * from gos");
$cnt = 1;
...
?>
            <tr>
                ...
                <td><a href="../images/gos/<?php echo $doc; ?>" download><?php echo $doc; ?></a></td>
                <td>
                 
                  <a href="admingos.php?step=delete&q=<?php echo $id; ?>" onClick="return deleteconfirm()" class="btn btn-danger"><i class='far'>&#xf2ed;</i></a>
              &nbsp;&nbsp;
                 <a href="adminfilesupdate.php?step=gosupdate&q=<?php echo $id; ?>"  class="btn" id="updatebtn"><i class='far'>&#xf044;</i></a>
