...
if(isset($_POST['submit'])){
    ...
    // $RandomNum   = time();
               ...
               $insert_img = mysqli_query($con,"insert into `gallerytable` SET `image_name`='".$filename."',`image_path`='".$fullname."'");
                 // $result = mysqli_array($insert_img);
               if($insert_img)
               {
                  echo '<script>alert("Successfully Upload");window.location.href="admingallery.php";</script>';
               }
   ...
   $id = $_POST['id'];
       ...
       if($del)
       {
           echo '<script>alert("Successfully Deleted");window.location.href="admingallery.php";</script>';
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><b>Gallery Images List<</b></h5>
