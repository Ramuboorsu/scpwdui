    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <center><h5 class="card-title"><b>To Beattended Grievance</b></h5></center>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                <?php
        $cnt=1;
$sel = mysqli_query($con,"select * from complaints_form where status='ToBeAttended'");
...
?>
            <tr>
                ...
                <td><?php echo $status; ?></td>
                 <td><a href="tobeattended.php?p=pending&id=<?php echo $id; ?>" class="btn btn-danger" onclick="return updateconfirm()">Pending</a>
                    <a href="tobeattended.php?a=DisposedOff&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">Disposed Off</a>
<a href="tobeattended.php?u=underprocess&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">Under Process</a></td>
