...
if(isset($_GET['p']))
  {
    $id =$_GET['id'];
    $update = mysqli_query($con,"update `complaints_form` set status='Pending' where `id` = '$id'")or die($conn->error);
  }else if(isset($_GET['a']))
{
    $id =$_GET['id'];
    $update = mysqli_query($con,"update `complaints_form` set status='DisposedOff' where `id` = '$id'")or die($con->error);
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <center><h5 class="card-title"><b>Underprocess Grievances</b></h5></center>
                        <div class="table-responsive">
                            <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                ...
                                <?php
        $cnt=1;
$sel = mysqli_query($con,"select * from complaints_form where status='Underprocess'");
...
?>
            <tr>
                ...
                <td><?php echo $status; ?></td>
                 <td><a href="underprocess.php?p=pending&id=<?php echo $id; ?>" class="btn btn-danger" onclick="return updateconfirm()">Pending</a>
                    <a href="underprocess.php?a=DisposedOff&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">Disposed Off</a>
<a href="underprocess.php?t=tobeattended&id=<?php echo $id;?>" class="btn btn-primary" onclick="return updateconfirm()">To Be Attended</a></td>
